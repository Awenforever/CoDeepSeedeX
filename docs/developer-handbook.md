...
- Current internal development checkpoint: `p2.17a5-custom-provider-chat-compat`
- Latest closed documentation sync checkpoint: `p2.17a5-custom-provider-chat-compat`
- Current public Release note synchronization checkpoint: `p2.17a5-custom-provider-chat-compat`
