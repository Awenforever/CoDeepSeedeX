...
- Current internal development checkpoint: `p2.19a5-codex-version-layout-compat`
- Latest closed documentation sync checkpoint: `p2.19a5-codex-version-layout-compat`
- Current public Release note synchronization checkpoint: `p2.19a5-codex-version-layout-compat`
...
### p2.19a5-codex-version-layout-compat release note policy
