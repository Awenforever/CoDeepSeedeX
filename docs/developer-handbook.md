...
- Current internal development checkpoint: `p2.21a3-installer-python-selection-order`
- Latest runtime checkpoint included in the public Release: `p2.20a2-provider-profile-primary-only-and-real-entry`
- Latest closed documentation sync checkpoint: `p2.21a3-installer-python-selection-order`
