...
- Current internal development checkpoint: `p2.18a4-stable-splash-entry`
- Latest closed documentation sync checkpoint: `p2.18a4-stable-splash-entry`
- Current public Release note synchronization checkpoint: `p2.18a4-stable-splash-entry`
...
### p2.18a4-stable-splash-entry release note policy
