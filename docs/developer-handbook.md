...
- Current internal development checkpoint: `p2.17a6-provider-capability-profiles`
- Latest closed documentation sync checkpoint: `p2.17a6-provider-capability-profiles`
- Current public Release note synchronization checkpoint: `p2.17a6-provider-capability-profiles`
