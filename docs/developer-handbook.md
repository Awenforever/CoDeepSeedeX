...
- Current internal development checkpoint: `p2.19a9-context-window-profile-source-consistency`
- Latest closed documentation sync checkpoint: `p2.19a9-context-window-profile-source-consistency`
- Current public Release note synchronization checkpoint: `p2.19a9-context-window-profile-source-consistency`
...
1. All observed image payloads remain protected and verbatim.
...
p2.15a4 publishes the p2.15 Codex 0.134+ profile-layout and custom-provider fixes as the public `v0.4.3-alpha` pre-release.

Release boundary:

1. `v0.4.3-alpha` is non-draft and pre-release.
...
### p2.19a9-context-window-profile-source-consistency release note policy
