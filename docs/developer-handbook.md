...
- Current internal development checkpoint: `p2.17a9-upgrade-ignore-managed-resources-dirty`
- Latest closed documentation sync checkpoint: `p2.17a9-upgrade-ignore-managed-resources-dirty`
- Current public Release note synchronization checkpoint: `p2.17a9-upgrade-ignore-managed-resources-dirty`
...
### p2.17a9-upgrade-ignore-managed-resources-dirty release note policy
