...
- Current internal development checkpoint: `p2.18a1-unified-guided-ui-upgrade-fallback`
- Latest closed documentation sync checkpoint: `p2.18a1-unified-guided-ui-upgrade-fallback`
- Current public Release note synchronization checkpoint: `p2.18a1-unified-guided-ui-upgrade-fallback`
...
### p2.18a1-unified-guided-ui-upgrade-fallback release note policy
