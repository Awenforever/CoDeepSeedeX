...
- 当前内部开发检查点：`p2.17a6-provider-capability-profiles`
- 最新闭合文档同步检查点：`p2.17a6-provider-capability-profiles`
- 当前公开Release note同步检查点：`p2.17a6-provider-capability-profiles`
