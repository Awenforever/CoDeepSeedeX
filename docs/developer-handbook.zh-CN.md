...
- 当前内部开发检查点：`p2.19a6-installer-ux-and-codex-detection-finalize`
- 最新闭合文档同步检查点：`p2.19a6-installer-ux-and-codex-detection-finalize`
- 当前公开Release note同步检查点：`p2.19a6-installer-ux-and-codex-detection-finalize`
...
### p2.19a6-installer-ux-and-codex-detection-finalize Release note 规范
