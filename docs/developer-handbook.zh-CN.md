...
- 当前内部开发检查点：`p2.18a9-concise-model-api-validation-hold`
- 最新闭合文档同步检查点：`p2.18a9-concise-model-api-validation-hold`
- 当前公开Release note同步检查点：`p2.18a9-concise-model-api-validation-hold`
...
### p2.18a9-concise-model-api-validation-hold Release note 规范
