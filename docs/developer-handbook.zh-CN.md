...
- 当前内部开发检查点：`p2.19a7-codex-wrapper-env-and-status-layout`
- 最新闭合文档同步检查点：`p2.19a7-codex-wrapper-env-and-status-layout`
- 当前公开Release note同步检查点：`p2.19a7-codex-wrapper-env-and-status-layout`
...
### p2.19a7-codex-wrapper-env-and-status-layout Release note 规范
