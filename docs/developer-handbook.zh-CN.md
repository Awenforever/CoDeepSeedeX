...
- 当前内部开发检查点：`p2.18a4-stable-splash-entry`
- 最新闭合文档同步检查点：`p2.18a4-stable-splash-entry`
- 当前公开Release note同步检查点：`p2.18a4-stable-splash-entry`
...
### p2.18a4-stable-splash-entry Release note 规范
