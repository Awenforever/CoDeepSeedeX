...
- 当前内部开发检查点：`p2.19a1-custom-provider-registry-foundation`
- 最新闭合文档同步检查点：`p2.19a1-custom-provider-registry-foundation`
- 当前公开Release note同步检查点：`p2.19a1-custom-provider-registry-foundation`
...
### p2.19a1-custom-provider-registry-foundation Release note 规范
