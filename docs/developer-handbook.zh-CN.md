...
- 当前内部开发检查点：`p2.18a8-stepwise-backspace-validation-summary`
- 最新闭合文档同步检查点：`p2.18a8-stepwise-backspace-validation-summary`
- 当前公开Release note同步检查点：`p2.18a8-stepwise-backspace-validation-summary`
...
### p2.18a8-stepwise-backspace-validation-summary Release note 规范
