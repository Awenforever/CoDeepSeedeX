...
- 当前内部开发检查点：`p2.17a9-upgrade-ignore-managed-resources-dirty`
- 最新闭合文档同步检查点：`p2.17a9-upgrade-ignore-managed-resources-dirty`
- 当前公开Release note同步检查点：`p2.17a9-upgrade-ignore-managed-resources-dirty`
...
### p2.17a9-upgrade-ignore-managed-resources-dirty Release note 规范
