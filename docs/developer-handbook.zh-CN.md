...
- 当前内部开发检查点：`p2.17a8-release-v043-alpha`
- 最新闭合文档同步检查点：`p2.17a8-release-v043-alpha`
- 当前公开Release note同步检查点：`p2.17a8-release-v043-alpha`
...
### p2.17a8-release-v043-alpha Release note 规范
