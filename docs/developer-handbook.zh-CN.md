...
- 当前内部开发检查点：`p2.16a5-terminal-ui-frame-backspace-correctness`
- 最新闭合文档同步检查点：`p2.16a5-terminal-ui-frame-backspace-correctness`
- 当前公开Release note同步检查点：`p2.16a5-terminal-ui-frame-backspace-correctness`
