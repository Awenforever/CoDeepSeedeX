...
- 当前内部开发检查点：`p2.19a8-codex-wrapper-real-binary-resolution`
- 最新闭合文档同步检查点：`p2.19a8-codex-wrapper-real-binary-resolution`
- 当前公开Release note同步检查点：`p2.19a8-codex-wrapper-real-binary-resolution`
...
### p2.19a8-codex-wrapper-real-binary-resolution Release note 规范
