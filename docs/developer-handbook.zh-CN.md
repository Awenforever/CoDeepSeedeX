...
- 当前内部开发检查点：`p2.19a5-codex-version-layout-compat`
- 最新闭合文档同步检查点：`p2.19a5-codex-version-layout-compat`
- 当前公开Release note同步检查点：`p2.19a5-codex-version-layout-compat`
...
### p2.19a5-codex-version-layout-compat Release note 规范
