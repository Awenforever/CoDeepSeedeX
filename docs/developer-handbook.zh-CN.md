...
- 当前内部开发线：`p2.10a35-docs-handoff-and-replacement-discipline`
- p2.10a35后的当前仓库基线：`master = origin/master = 659854a`
- 旧公开tag不能移动：
...
- 公开Release资产仍为`bootstrap.sh`和`install.sh`；p2.10a35和p2.10a36不重建资产。
