...
def _shell_quote(value: str) -> str:
    return _quote_env_value_data(value)


def _read_env_exports(path: Path) -> dict[str, str]:
    return _read_env_exports_data(path)
...
def _write_env_exports(path: Path, values: dict[str, str]) -> None:
    ...
    _write_env_exports_data(
        path,
        values,
        ordered_keys=ordered_keys,
        header=("# codexchange local environment", "# Generated by cox"),
    )
...
def _write_custom_provider_model_catalog(
    ...
    *,
    ...
    models.append({
        ...
        "provider_id": provider_id,
        "provider_type": entry.get("type") or "custom_openai_compatible",
        ...
        "base_instructions": "You are Codex, a coding agent. Help the user complete software engineering tasks accurately.",
        "model_messages": {
...
def _debug_behavioral_check_from_long_session(long_session: object) -> dict[str, object]:
    ...
    metrics = {
        ...
        "last_provider_payload_mtime": long_session.get("last_provider_payload_mtime"),
        "last_provider_payload_size": long_session.get("last_provider_payload_size"),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    debug_status.add_argument("--reasoning", "--thinking", dest="thinking", action="store_true", help="use reasoning route (legacy alias: --thinking)")
    ...
    debug_latest.add_argument("--reasoning", "--thinking", dest="thinking", action="store_true", help="use reasoning route (legacy alias: --thinking)")
    ...
    debug_budget.add_argument("--reasoning", "--thinking", dest="thinking", action="store_true", help="use reasoning route (legacy alias: --thinking)")
    ...
    debug_behavioral.add_argument("--reasoning", "--thinking", dest="thinking", action="store_true", help="use reasoning route (legacy alias: --thinking)")
    ...
    debug_long_session.add_argument("--reasoning", "--thinking", dest="thinking", action="store_true", help="use reasoning route (legacy alias: --thinking)")
    ...
    debug_semantic.add_argument("--reasoning", "--thinking", dest="thinking", action="store_true", help="use reasoning route (legacy alias: --thinking)")
