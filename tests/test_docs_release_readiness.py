...
def test_developer_handbook_current_release_state_is_synced_to_latest_release_note_node() -> None:
    ...
    assert "Current internal development checkpoint: `p2.22a2-test-isolation-and-validation`" in en_current
    ...
    assert "当前内部开发检查点：`p2.22a2-test-isolation-and-validation`" in zh_current
